...
async def _(event):
    ...
    animation_chars = [
        "Heroku Connecting To Latest Github Build (Yansensad/yansdn-userbot)",
        ...
        "INFO - Yansen-Userbot: Logged in as 557667062",
        "INFO - Yansen-Userbot: Successfully...",
        "919852+00:00 app[worker.1]: 919 - yansen-userbot -",
        "INFO - ⚡ yansen-userbot ⚡ ⚙️ V7.0 [TELAH DIAKTIFKAN!]",
        "**Build Succeeded**",
    ]
