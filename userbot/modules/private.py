    ...
    if chat.id != OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**Users**: {mention}\
                        ...
                        \n**Forward**: True\
                        \n\n**Powered by**: [Lepin](https://t.me/lepinex)"
            buttons = [
                (
...
async def infor(event):
    await tgbot.send_message(
        event.chat_id,
        message=f"**Groups**: [sᴜᴘᴘᴏʀᴛ](t.me/YansenSupportt)\n**Github**: [Yansen-Userbot](https://github.com/Yansensad/yansen-userbot)\n**Deploy**: [Via Bot](https://telegram.dog/XTZ_HerokuBot?start=WWFuc2Vuc2FkL3lhbnNlbi11c2VyYm90IFlhbnNlbi1Vc2VyYm90)",
        buttons=[
            [
                custom.Button.inline(
                    "ᴄʟᴏꜱᴇ",
