...
from userbot.utils import edit_or_reply, lepin_cmd
...
@register(incoming=True, from_users=DEVS, pattern=r"^-hy$")
async def _(lepin):
    await lepin.reply(random.choice(roas))
