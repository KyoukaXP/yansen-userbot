...
REPOLINK = str(
    UPSTREAM_REPO_URL) if UPSTREAM_REPO_URL else "https://github.com/Yansensad/yansen-userbot"
# ============================================
...
CMD_HELP.update({
    ...
    \n↳ : `.sleep`\
    \n  •  **Function : Biarkan Yansen-Userbot tidur selama beberapa detik.",
    "shutdown": "𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.shutdown`\
    \n↳ : Mematikan bot",
    "repo": "𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.repo`\
    \n↳ : Menampilan link Repository Yansen-Userbot.",
    "string": "𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.string`\
    \n↳: Menampilkan link String Yansen-Userbot",
