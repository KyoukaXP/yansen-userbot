...
@lepin_cmd(pattern="(?:skyzualive)\s?(.)?")
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╰✠╼━━━━━━━━━━━━━━━✠╯\n"
        f"[ɢʀᴏᴜᴘꜱ](https://t.me/pantekyks) | [ʙᴏᴛᴏꜰ](https://t.me/{user.username}) | [ɢɪᴛʜᴜʙ](https://github.com/Yansensad/yansen-userbot)"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
@lepin_cmd(pattern="(?:pinon)\s?(.)?")
async def amireallyalive(alive):
    await bot.get_me()
    await get_readable_time((time.time() - StartTime))
    output = (
        f"●▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬● \n"
        f"✾ 🤴 • `ᴏᴡɴᴇʀ :`[Lepin](t.me/lepinex)             ㅤ \n"
...
async def redis(alive):
    ...
    output = (
        ...
        f"┃✧ **GitHub   :** [Userbot](https://github.com/Yansensad/yansen-userbot) \n"
...
CMD_HELP.update(
    {
        "alive": f"𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}alive` or `{cmd}on` or `lepin`"
