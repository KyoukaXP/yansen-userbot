...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╰✠╼━━━━━━━━━━━━━━━✠╯\n"
        f"[ɢʀᴏᴜᴘꜱ](https://t.me/YansenSupport) | [ᴄʜᴀɴɴᴇʟ](t.me/trashme2) | [ᴏᴡɴᴇʀ](https://t.me/yansesad) | [ɢɪᴛʜᴜʙ](https://github.com/Yansensad/yansen-userbot)"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def redis(alive):
    ...
    output = (
        ...
        f"┣  `GitHub   :` [Repo](https://github.com/Yansensad/yansen-userbot) \n"
