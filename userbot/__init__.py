...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/Yansensad/yansen-userbot")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "Yansen-Userbot")
...
Yansen_TEKS_KUSTOM = os.environ.get(
    "Yansen_TEKS_KUSTOM",
    "I'am Using Yansen-Userbot⚡")
...
async def check_alive():
    await bot.send_file(BOTLOG_CHATID, ALIVE_LOGO, caption=f"**Yansen-Userbot ʙᴇʀʜᴀsɪʟ ᴅɪᴀᴋᴛɪғᴋᴀɴ⚡**\n━━━━━━━━━━━━━━━━━━━\n❃ **ʙᴏᴛ ᴏꜰ :** {ALIVE_NAME}\n❃ **ʙᴏᴛ ᴠᴇʀ :** 7.0\n━━━━━━━━━━━━━━━━━━━\n❃ **sᴜᴘᴘᴏʀᴛ​ :** @YansenSupport\n❃ **ᴄʜᴀɴɴᴇʟ​ :** @trashme2 \n━━━━━━━━━━━━━━━━━━━")
    return
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    ...
                    f"× **Pembaruan Data Untuk Yansen Userbot, Command Untuk Pembaruan**.\n"
                    f"⚒Pembaruan Data :\n"
                    f"`.update deploy`\n"
                    f"`update`\n\n"
                    f"© @yansesad")
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = builder.article(
                    ...
                    buttons=[
                        ...
                        [custom.Button.url(
                            "ʟɪᴄᴇɴsᴇ",
                            "https://github.com/Yansensad/yansen-userbot/LICENSE")],
                    ],
                    link_preview=False,
                )
